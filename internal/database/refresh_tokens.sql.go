...
VALUES ($1,
        ...
        $2,
        $3,
        $4) RETURNING token, created_at, updated_at, user_id, expires_at, revoked_at
`
...
func (q *Queries) UpdateRefreshTokenRevokedAtByToken(ctx context.Context, arg UpdateRefreshTokenRevokedAtByTokenParams) error {
	_, err := q.db.ExecContext(ctx, updateRefreshTokenRevokedAtByToken, arg.RevokedAt, arg.Token)
	return err
}
